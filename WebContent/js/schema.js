...
function editableTable(){
	...
	$(".editable").each(function() {   
	    ...
	    $(".editFieldName").each(function() {   
	        ...
	        var input = $("<input type='text' id= '"+objTD.attr("id")+"' size='16' maxlength='12' class='inp02 alphanumeric' value='" + oldText + "' />");   
	   ...
	   $(".chk").click(function() {
	    ...
	    $(".sltindex").change(function() {
	        ...
	        if(sltValue.length > 1){
	        	//sltValue = "com.websqrd.fastcat.ir.tokenizer."+sltValue+"Tokenizer";
	        }else{
	        	sltValue = "";
	        }
	            var id = $(this).attr("id");  
