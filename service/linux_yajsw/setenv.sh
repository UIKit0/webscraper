...
confPath=`pwd`
"$java_exe" -classpath ../yajsw_conf.jar com.websqrd.catbot.yajsw.ConfWriter "$confPath"/wrapper.conf ../../ "$yajsw_java_options" "$yajsw_account_user" "$yajsw_account_password"
